...
async function doPrerender(config, defaultPaths, autoCrawl) {
  var _a, _b;
  autoCrawl = autoCrawl ?? !(defaultPaths == null ? void 0 : defaultPaths.length);
  const outDir = path.resolve(config.root, config.build.outDir);
  let pathNames = defaultPaths ?? (((_b = (_a = config.api) == null ? void 0 : _a.rakkas) == null ? void 0 : _b.prerender) || []);
    ...
    await handler({
      ...
      platform: {
        async render(pathname, response, options, error) {
          ...
          const isPage = ((_a2 = response.headers.get("content-type")) == null ? void 0 : _a2.split(";")[0]) === "text/html";
          if (isPage) {
  ...
  if (fileNames.length > 0) {
    ...
    for (const fileName of fileNames) {
      ...
      if (error) {
        config.logger.error(error == null ? void 0 : error.stack);
      }
    }
  }
}
