...
var IsomorphicContext = createContext(void 0);
var ServerSideContext = createContext(
  void 0
);

// src/features/use-query/implementation.ts
var QueryCacheContext = createContext2(void 0);
...
const { useRef, useState } = __REACT_IMPORT__3;
...
var LocationContext = createContext3(void 0);
...
var Link = forwardRef(
  ({
    ...
    onNavigationStart,
    ...props
  }, ref) => /* @__PURE__ */ React2.createElement("a", {
    ...props,
    ref,
    onClick: (e2) => {
...
function ClientSuspense(props) {
  return /* @__PURE__ */ React3.createElement(ClientOnly, {
    fallback: props.fallback
  }, /* @__PURE__ */ React3.createElement(Suspense, {
    fallback: props.fallback
  }, props.children));
}
var ClientOnlyContext = createContext4(void 0);
...
var Redirect = import.meta.env.SSR ? function Redirect2(props) {
  ...
  return /* @__PURE__ */ React4.createElement(React4.Fragment, null, /* @__PURE__ */ React4.createElement("script", {
...
var ResponseContext = createContext5(() => void 0);
...
function Wrapper({ children }) {
  return /* @__PURE__ */ React6.createElement(QueryCacheContext.Provider, {
    value: cache
  }, children);
}
var cache = {
...
// src/features/error-boundary/implementation.tsx
var ErrorBoundary2 = (props) => /* @__PURE__ */ React7.createElement(ErrorBoundary, {
  ...props,
  onReset: () => {
    var _a;
    resetErrors();
...
// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/types.js
var types = [
  ts({
    is: (val) => val === void 0,
...
// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/utils/isReactElement.js
function isReactElement(value) {
  return typeof value === "object" && value !== null && String(value["$$typeof"]) === "Symbol(react.element)";
}

// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/utils/isCallable.js
function isCallable(thing) {
  return thing instanceof Function || typeof thing === "function";
}

// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/utils/isObject.js
...
// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/stringify.js
function stringify(value, { forbidReactElements, space, valueName = "value", sortObjectKeys } = {}) {
  ...
  function genErrMsg(valueType, valName) {
    ...
    return `Cannot serialize${name}${location2}${fallback} because it is a ${valueType} (https://github.com/brillout/json-s)`;
  }
}
...
function runSSQImpl(ctx, desc) {
  ...
  return Promise.resolve(fn(closure, ctx)).then(async (result) => {
    if (process.env.RAKKAS_PRERENDER === "true") {
      ...
      const url = `/_data/${import.meta.env.RAKKAS_BUILD_ID}/` + moduleId + "/" + counter + closurePath + "/d.js";
...
const { Fragment: Fragment2, StrictMode, Suspense: Suspense2 } = React10;
...
function Default404Page() {
  return import.meta.env.DEV ? /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(Head, {
    title: "Not Found"
  }), /* @__PURE__ */ React8.createElement("h1", null, "Not Found"), /* @__PURE__ */ React8.createElement("p", null, "This is Rakkas's default 404 page. It will ", /* @__PURE__ */ React8.createElement("b", null, "not be available"), " ", "when you build your application for production and a bare \u201CNot Found\u201D message will be displayed instead."), /* @__PURE__ */ React8.createElement("p", null, "Create a ", /* @__PURE__ */ React8.createElement("code", null, "$404.page.jsx"), " in your ", /* @__PURE__ */ React8.createElement("code", null, "routes"), " ", "directory to provide a custom 404 page.")) : /* @__PURE__ */ React8.createElement(React8.Fragment, null, /* @__PURE__ */ React8.createElement(Head, {
    title: "Not Found"
  }), /* @__PURE__ */ React8.createElement("h1", null, "Not Found"));
}
...
function App(props) {
  ...
  if (!lastRoute.last || lastRoute.last.pathname !== pageContext.url.pathname || lastRoute.last.search !== pageContext.url.search || forcedUpdate) {
...
var RouteContext = createContext6({
  updateCounter: 0
});
async function loadRoute(pageContext, lastFound, try404, beforePageLookupHandlers, actionData, ssrMeta, ssrPreloaded, ssrModules) {
  ...
  for (const hook of beforePageLookupHandlers) {
    ...
    if ("redirect" in result) {
      ...
      return {
        ...
        actionData,
        app: /* @__PURE__ */ React9.createElement(Redirect, {
          href: location2,
  ...
  if (!found || import.meta.hot) {
    ...
    if (import.meta.env.PROD) {
      ...
      if (import.meta.hot) {
        updatedRoutes = (await import(
          /* @vite-ignore */
          "/virtual:rakkasjs:client-page-routes?" + Date.now()
        )).default;
      }
    }
  ...
  if (import.meta.env.SSR) {
    ...
    preloadNode = preloaded.map(
      (result, i2) => ((result == null ? void 0 : result.head) || (result == null ? void 0 : result.redirect)) && /* @__PURE__ */ React9.createElement(Fragment, {
        key: i2
      }, result == null ? void 0 : result.head, (result == null ? void 0 : result.redirect) && /* @__PURE__ */ React9.createElement(Redirect, {
        ...result == null ? void 0 : result.redirect
      }))
    ).filter(Boolean);
  }
  ...
  let app = components.reduce(
    (prev, Component2) => /* @__PURE__ */ React9.createElement(Component2, {
      url: pageContext.url,
      params: found.params,
      meta,
      actionData
...
async function renderPageRoute(ctx) {
  ...
  if (ctx.request.headers.get("accept") === "application/javascript") {
    ...
    return new Response(uneval2(actionResult), {
  ...
  const preloaded = await Promise.all(
    modules.reverse().map(async (m2, i2) => {
      var _a2, _b2;
      try {
  ...
  const preloadNode = preloaded.map((result, i2) => {
    return ((result == null ? void 0 : result.head) || (result == null ? void 0 : result.redirect)) && /* @__PURE__ */ React10.createElement(Fragment2, {
      key: i2
    }, result == null ? void 0 : result.head, (result == null ? void 0 : result.redirect) && /* @__PURE__ */ React10.createElement(Redirect, {
      ...result == null ? void 0 : result.redirect
    }));
  }).filter(Boolean);
  let app = /* @__PURE__ */ React10.createElement(App, {
  ...
  if (preloadNode.length) {
    app = /* @__PURE__ */ React10.createElement(React10.Fragment, null, preloadNode, app);
  }
  app = /* @__PURE__ */ React10.createElement(ServerSideContext.Provider, {
    value: ctx
  }, /* @__PURE__ */ React10.createElement(IsomorphicContext.Provider, {
    value: pageContext
  }, app));
  ...
  for (const m2 of modules) {
    const headers2 = await ((_d = m2.headers) == null ? void 0 : _d.call(m2, preloadContext, meta));
    if (headers2) {
    ...
    if (process.env.RAKKAS_PRERENDER === "true") {
      ...
      for (const m3 of modules) {
        const value = await ((_e = m3.prerender) == null ? void 0 : _e.call(m3, preloadContext, meta));
        if (value) {
          prerender2 = {
            ...prerender2,
            ...value,
  ...
  app = /* @__PURE__ */ React10.createElement("div", {
    id: "root"
  }, /* @__PURE__ */ React10.createElement(ResponseContext.Provider, {
    value: updateHeaders
  }, /* @__PURE__ */ React10.createElement(RouteContext.Provider, {
    value: {
      onRendered() {
  ...
  }, /* @__PURE__ */ React10.createElement(Suspense2, null, app))));
  let scriptPath;
  if (import.meta.env.PROD) {
  ...
  if (import.meta.env.PROD) {
    ...
    for (const moduleId of moduleSet) {
      const manifestEntry = (_f = clientManifest) == null ? void 0 : _f[moduleId];
      if (!manifestEntry)
        continue;
      (_g = manifestEntry.imports) == null ? void 0 : _g.forEach((id) => moduleSet.add(id));
      (_h = manifestEntry.css) == null ? void 0 : _h.forEach((id) => cssSet.add(id));
      const script = (_i = clientManifest) == null ? void 0 : _i[moduleId].file;
      if (script) {
    ...
    for (const moduleId of moduleSet) {
      const module = viteDevServer.moduleGraph.getModuleById(moduleId) ?? viteDevServer.moduleGraph.getModuleById(root + "/" + moduleId);
      if (!module)
        continue;
  ...
  if (import.meta.env.DEV && process.env.RAKKAS_STRICT_MODE === "true") {
    app = /* @__PURE__ */ React10.createElement(StrictMode, null, app);
  }
  ...
  let head = `<!DOCTYPE html><html><head>` + prefetchOutput + `<meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" />` + ((actionResult == null ? void 0 : actionResult.data) === void 0 ? "" : `<script>$RAKKAS_ACTION_DATA=${uneval2(actionResult == null ? void 0 : actionResult.data)}<\/script>`);
  ...
  if (import.meta.env.DEV) {
    head += `<script type="module" src="/@vite/client"><\/script><script type="module" async>${REACT_FAST_REFRESH_PREAMBLE}<\/script>`;
  }
  head += `</head><body>`;
...
var headServerHooks = {
  createPageHooks() {
    ...
    return {
      wrapApp: (app) => {
        return /* @__PURE__ */ React11.createElement(q, {
...
var useQueryServerHooks = {
  createPageHooks() {
    ...
    return {
      wrapApp: (app) => {
        return /* @__PURE__ */ React12.createElement(QueryCacheContext.Provider, {
          value: cache2
        }, app);
      },
      extendPageContext(ctx) {
      ...
      emitToDocumentHead() {
        const newItemsString = uneval3(cache2._getNewItems());
...
// ../../node_modules/.pnpm/@brillout+json-serializer@0.5.1/node_modules/@brillout/json-serializer/dist/esm/parse.js
function parse(str) {
...
import { uneval as uneval4 } from "devalue";
    ...
    beforeApiRoutes: async (ctx) => {
      ...
      try {
        if (ctx.method === "POST") {
          ...
          closureContents = closure.map((s2) => parse(decodeBase64(s2)));
        }
      } catch (e2) {
        return new Response("Parse error", { status: 400 });
      }
      const manifest = await import("virtual:rakkasjs:run-server-side:manifest");
      ...
      return new Response(uneval4(result));
    }
  },
...
function decodeBase64(s2) {
  s2 = s2.replace(/_/g, "/").replace(/-/g, "+");
  if (typeof Buffer !== "undefined") {
    return Buffer.from(s2, "base64").toString("utf8");
  } else {
    return atob(s2);
  }
}
...
function DefaultErrorPage(props) {
  ...
  }, "Retry"))) : /* @__PURE__ */ React14.createElement(React14.Fragment, null, /* @__PURE__ */ React14.createElement("h1", null, "Internal Error"));
}
export {
  ClientOnly,
  ClientSuspense,
