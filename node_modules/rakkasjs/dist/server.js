...
import { devalue as devalue2 } from "devalue";
...
async function renderPageRoute(ctx) {
  ...
  let redirected;
  let status = ctx.notFound ? 404 : 200;
  ...
  if (ctx.request.headers.get("accept") === "application/javascript") {
    ...
    return new Response(devalue2(actionResult), {
  ...
  const meta = {};
  preloaded.forEach((p2) => Object.assign(meta, p2 == null ? void 0 : p2.meta));
  const preloadNode = preloaded.map((result, i2) => /* @__PURE__ */ React10.createElement(Fragment2, {
    key: i2
  }, result == null ? void 0 : result.head, (result == null ? void 0 : result.redirect) && /* @__PURE__ */ React10.createElement(Redirect, {
    ...result == null ? void 0 : result.redirect
  })));
  let app = /* @__PURE__ */ React10.createElement(ServerSideContext.Provider, {
    value: ctx
  }, /* @__PURE__ */ React10.createElement(IsomorphicContext.Provider, {
    value: pageContext
  }, preloadNode, /* @__PURE__ */ React10.createElement(App, {
  ...
  const reactStream = await renderToReadableStream(
    /* @__PURE__ */ React10.createElement(StrictMode, null, app),
    {
  ...
  let head = `<!DOCTYPE html><html><head>` + prefetchOutput + `<meta charset="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" />` + ((actionResult == null ? void 0 : actionResult.data) === void 0 ? "" : `<script>$RAKKAS_ACTION_DATA=${devalue2(actionResult == null ? void 0 : actionResult.data)}<\/script>`);
...
import { devalue as devalue3 } from "devalue";
var useQueryServerHooks = {
  createPageHooks() {
    ...
    return {
      ...
      emitToDocumentHead() {
        const newItemsString = devalue3(cache2._getNewItems());
...
import { devalue as devalue4 } from "devalue";
var runServerSideServerHooks = {
  middleware: {
    beforeApiRoutes: async (ctx) => {
      ...
      return new Response(devalue4(result));
    }
  },
