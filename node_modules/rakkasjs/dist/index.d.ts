...
declare function useSubmit(options?: UseMutationOptions<void, HTMLFormElement>): {
    ...
    mutateAsync(vars: HTMLFormElement): Promise<void>;
    reset(): void;
} | {
    submitHandler: (e: FormEvent<HTMLFormElement>) => void;
    status: "loading";
