...
function sendRequest(moduleId, counter, stringified, usePostMethod, vars) {
  ...
  if (usePostMethod) {
    response = fetch(
      ...
      {
        method: "POST",
        body: "[[" + stringified.join(",") + "]" + (vars !== void 0 ? "," + stringify(vars) : "") + "]"
      }
    );
  } else {
    let closurePath = stringified.map((s2) => btoa(s2).replace(/\//g, "_").replace(/\+/g, "-")).join("/");
    if (closurePath)
...
const { StrictMode, Suspense: Suspense2 } = React14;
...
function Default404Page() {
  return import.meta.env.DEV ? /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(Head, {
    title: "Not Found"
  }), /* @__PURE__ */ React9.createElement("h1", null, "Not Found"), /* @__PURE__ */ React9.createElement("p", null, "This is Rakkas's default 404 page. It will ", /* @__PURE__ */ React9.createElement("b", null, "not be available"), " ", "when you build your application for production and a bare \u201CNot Found\u201D message will be displayed instead."), /* @__PURE__ */ React9.createElement("p", null, "Create a ", /* @__PURE__ */ React9.createElement("code", null, "$404.page.jsx"), " in your ", /* @__PURE__ */ React9.createElement("code", null, "routes"), " ", "directory to provide a custom 404 page.")) : /* @__PURE__ */ React9.createElement(React9.Fragment, null, /* @__PURE__ */ React9.createElement(Head, {
    title: "Not Found"
  }), /* @__PURE__ */ React9.createElement("h1", null, "Not Found"));
}
...
async function loadRoute(pageContext, lastFound, try404, beforePageLookupHandlers, actionData, ssrMeta, ssrPreloaded, ssrModules) {
  ...
  for (const hook of beforePageLookupHandlers) {
    ...
    if ("redirect" in result) {
      ...
      return {
        ...
        actionData,
        app: /* @__PURE__ */ React10.createElement(Redirect, {
          href: location2,
  ...
  if (import.meta.env.SSR) {
    ...
    preloadNode = preloaded.map(
      (result, i2) => ((result == null ? void 0 : result.head) || (result == null ? void 0 : result.redirect)) && /* @__PURE__ */ React10.createElement(Fragment, {
        key: i2
  ...
  let app = components.reduce(
    (prev, Component2) => /* @__PURE__ */ React10.createElement(Component2, {
      url: pageContext.url,
      params: found.params,
      meta,
      actionData
...
var client_hooks_default2 = defineClientHooks({
  wrapApp(app) {
    return /* @__PURE__ */ React11.createElement(q, null, app);
  }
});

// src/features/client-only/client-hooks.tsx
import * as React12 from "react";
const { useReducer: useReducer2 } = React12;
var client_hooks_default3 = defineClientHooks({
  wrapApp(app) {
    return /* @__PURE__ */ React12.createElement(ClientOnlyWrapper, null, app);
  }
});
function ClientOnlyWrapper(props) {
  const [hydrated, setHydrated] = useReducer2(() => true, false);
  return /* @__PURE__ */ React12.createElement(ClientOnlyContext.Provider, {
    value: { hydrated, setHydrated }
  }, props.children);
}
...
async function startClient(options = {}) {
  ...
  let app = /* @__PURE__ */ React14.createElement(IsomorphicContext.Provider, {
    value: pageContext
  }, /* @__PURE__ */ React14.createElement(App, {
  ...
  app = /* @__PURE__ */ React14.createElement(RouteContext.Provider, {
    value: "error" in route ? route : { last: route }
  }, /* @__PURE__ */ React14.createElement(Suspense2, null, /* @__PURE__ */ React14.createElement(ErrorBoundary2, {
    FallbackComponent: ErrorComponent
  }, app)));
  if (import.meta.env.DEV && process.env.RAKKAS_STRICT_MODE === "true") {
    app = /* @__PURE__ */ React14.createElement(StrictMode, null, app);
  }
...
const { useEffect: useEffect4 } = React15;
function DefaultErrorPage(props) {
  ...
  return import.meta.env.DEV ? /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("h1", null, "Internal Error"), /* @__PURE__ */ React15.createElement("p", null, "This is Rakkas's default error page. It will", " ", /* @__PURE__ */ React15.createElement("b", null, "not be available"), " when you build your application for production and a bare \u201CInternal Error\u201D message will be displayed instead."), /* @__PURE__ */ React15.createElement("p", null, "Use ", /* @__PURE__ */ React15.createElement("code", null, "ErrorBoundary"), " to catch errors and create a", " ", /* @__PURE__ */ React15.createElement("code", null, "$error.jsx"), " in your ", /* @__PURE__ */ React15.createElement("code", null, "routes"), " directory to provide a last resort error page."), message && /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("h2", null, "Error message"), /* @__PURE__ */ React15.createElement("pre", null, message)), /* @__PURE__ */ React15.createElement("p", null, /* @__PURE__ */ React15.createElement("button", {
    type: "button",
    onClick: () => location.reload()
  }, "Retry"))) : /* @__PURE__ */ React15.createElement(React15.Fragment, null, /* @__PURE__ */ React15.createElement("h1", null, "Internal Error"));
}
export {
  ClientOnly,
  ClientSuspense,
