...
// src/features/run-server-side/lib-client.ts
...
function ClientOnlyWrapper(props) {
  ...
  return /* @__PURE__ */ React11.createElement(ClientOnlyContext.Provider, {
...
var client_hooks_default4 = defineClientHooks({
  ...
  wrapApp(app) {
    return /* @__PURE__ */ React12.createElement(LocationContext.Provider, {
      value: location.href
    }, app);
  }
});
...
async function startClient(options = {}) {
  ...
  let app = /* @__PURE__ */ React13.createElement(IsomorphicContext.Provider, {
    value: pageContext
  }, /* @__PURE__ */ React13.createElement(App, {
  ...
  app = /* @__PURE__ */ React13.createElement(StrictMode, null, /* @__PURE__ */ React13.createElement(RouteContext.Provider, {
    value: "error" in route ? route : { last: route }
  }, /* @__PURE__ */ React13.createElement(Suspense2, null, /* @__PURE__ */ React13.createElement(ErrorBoundary2, {
