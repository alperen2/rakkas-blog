...
import { IncomingMessage, ServerResponse, ServerOptions, Server } from 'http';
...
declare type NodeMiddleware = (req: DecoratedRequest, res: ServerResponse, next?: () => void) => void;
/** Adapter options */
