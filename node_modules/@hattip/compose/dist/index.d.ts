...
declare type ResponseLike = Response | ResponseConvertible;
declare type MaybeRespone = ResponseLike | void;
declare type MaybeAsyncResponse = MaybeRespone | Promise<MaybeRespone>;
declare type RequestHandler = (context: RequestContext) => MaybeAsyncResponse;
declare type MaybeRequestHandler = false | null | undefined | RequestHandler;
