...
function vaviteDevServerPlugin() {
  ...
  return {
    ...
    enforce: "pre",
    buildStart() {
      globalSymbol = "VAVITE_VITE_DEV_SERVER_" + import_crypto.default.randomBytes(20).toString("hex");
    ...
    resolveId(source, _importer, options) {
      if ((source === "@vavite/expose-vite-dev-server/vite-dev-server" || source === "vavite/vite-dev-server") && dev && options.ssr) {
